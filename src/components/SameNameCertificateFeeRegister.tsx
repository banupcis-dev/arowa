...
function SameNameCertificateFeeRegister() {
  ...
  useEffect(() => {
    const savedFees = JSON.parse(
      localStorage.getItem("sameNameCertificateFeeRegister") || "[]"
    );
  ...
  return (
    <div className="preview-container">
      ...
      <h2>একই নামে সনদ পত্র ফি আদায় রেজিস্টার</h2>
...
export default SameNameCertificateFeeRegister;