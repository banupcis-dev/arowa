...
useEffect(() => {
  ...
  return (
    <div className="preview-container">
      ...
      <h2>জন্ম নিবন্ধন ফি আদায় রেজিস্টার</h2>
      ...
      <div className="table-scroll">
        ...
        <div className="register-total">
          ...
          <p>
            <strong>মোট আবেদন ফি :</strong>{" "}
            {totalApplicationFee} টাকা
          </p>

          <p>
            <strong>মোট সার্ভিস চার্জ :</strong>{" "}
            {totalServiceCharge} টাকা
          </p>

          <h3>
            <strong>সর্বমোট আদায় :</strong>{" "}
            {grandTotal} টাকা
          </h3>
...
export default BirthFeeRegister;